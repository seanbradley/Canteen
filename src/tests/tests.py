...
Canteen was not tested before deployment on Google App Engine.

This test was developed for application models (e.g., "example") no longer part of this code-base;
I've left the test here to assist in developing a proper test in the future.
